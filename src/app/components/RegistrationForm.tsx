...
const RegisterForm: FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 motion-preset-slide-down-left motion-duration-1000">
      <Formik
        initialValues={{
          email: "",
          password: "",
