    ...
    <header className=''>
      <div className='flex bg-neutral-100 p-2 justify-between items-center rounded-4xl shadow-md'>
        ...
        <div className='flex gap-2'>
          {
          store.isAuth ? 
          <button onClick={() => store.logout()} className='flex bg-lime-200 p-3 rounded-4xl w-30 items-center justify-center hover:bg-lime-300 focus:bg-lime-300 transition-colors duration-300 ease-in-out'>Log Out</button> : 
          <React.Fragment>
